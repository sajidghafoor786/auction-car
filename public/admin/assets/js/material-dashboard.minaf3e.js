...
function dropDown(e) {
    if (!document.querySelector(".dropdown-hover")) {
        ...
        for (
            var t = e.parentElement.parentElement.children, a = 0; a < t.length; a++
        )
...
function sidebarColor(e) {
    ...
    if (document.querySelector("#sidenavCard")) {
        ...
        t = document.querySelector("#sidenavCard");
        t.className = "";
        t.classList.add(...e);
        ...
        t = document.querySelector("#sidenavCardIcon");
        t.className = "";
        t.classList.add(...e);
    }
}
...
function sidebarType(e) {
    ...
    e.classList.contains("active") ?
        ...
        e.classList.add("active");
    for (
        var r, o, c, d = document.querySelector(".sidenav"), s = 0; s < l.length; s++
    )
...
window.addEventListener("resize", navbarColorOnResize),
    ...
    (window.onload = function() {
        for (
            var e = document.querySelectorAll("input"), t = 0; t < e.length; t++
        )
        ...
        for (
            var a = document.querySelectorAll(".btn"), t = 0; t < a.length; t++
        )
