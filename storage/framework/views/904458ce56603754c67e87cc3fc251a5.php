                                    ...
                                    <div class="card-body bg-light mb-3">
                                        <div class="row">
                                            <div class="col-6 col-lg-2">
                                               ...
                                               <?php if(!empty($bid->auction->car->image)): ?>
                                                    <img src="<?php echo e(asset('storage/' . $bid->auction->car->image)); ?>" alt="Car Image" class="img-fluid rounded" width="100">
                                                <?php endif; ?>
                                            ...
                                            <div class="col-6 col-lg-3">
                                                ...
                                                <p class="mb-lg-0 fs-sm fw-bold">
                                                    <?php echo e($bid->auction->car->name ?? 'N/A'); ?>
                                            ...
                                            <div class="col-6 col-lg-3">
                                                ...
                                                <p class="mb-lg-0 fs-sm fw-bold">
                                                    <?php echo e(number_format($bid->bid_amount, 2)); ?>/PKR
                                                </p>
                                            </div>
                                            <div class="col-6 col-lg-2">
                                                <h6 class="heading-xxxs text-muted">End Date:</h6>
                                                <p class="mb-lg-0 fs-sm fw-bold">
                                                    <?php echo e(\Carbon\Carbon::parse($bid->auction->end_date)->format('d F, Y')); ?>

                                                </p>
                                            </div>
                                            <div class="col-6 col-lg-2">
                                                <h6 class="heading-xxxs text-muted">Status:</h6>
                                                <?php if($bid->auction->end_date < now()): ?>
                                                    <?php if(isset($endedAuctions[$bid->auction_id]) && $endedAuctions[$bid->auction_id] == $bid->bid_amount): ?>
...
<?php echo $__env->make('frontend.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\auction-car\resources\views/frontend/auction-history.blade.php ENDPATH**/ ?>