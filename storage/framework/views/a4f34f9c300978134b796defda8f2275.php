    ...
    <div class="container">
        <nav class="navbar navbar-expand-xl" id="navbar">
            <div class="col-lg-4 logo">
                <a href="<?php echo e(url('/')); ?>" class="text-decoration-none text-white fw-bold fs-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="col-lg-6  col-6  d-flex justify-content-end align-items-center">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('user.login')); ?>" class="nav-link text-white me-2 justify-content-start d-flex"><i class="far fa-user me-1"></i> Login</a>
                    <?php endif; ?>
...
<?php /**PATH D:\laragon\www\auction-car\resources\views/frontend/include/header.blade.php ENDPATH**/ ?>