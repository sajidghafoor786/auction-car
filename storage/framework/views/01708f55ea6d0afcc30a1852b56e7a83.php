                        ...
                        <div class="card-body">
                            ...
                            <div class="leave-info-box">
                                <div class="media align-items-center">
                                    <a href="profile.html" class="avatar"><img alt="" src="admin/assets/img/user.jpg"></a>
                                ...
                                <table class="table custom-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt="" src="admin/assets/img/profiles/avatar-19.jpg"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="client-profile.html" class="avatar"><img alt="" src="admin/assets/img/profiles/avatar-07.jpg"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="client-profile.html" class="avatar"><img alt="" src="admin/assets/img/profiles/avatar-06.jpg"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="client-profile.html" class="avatar"><img alt="" src="admin/assets/img/profiles/avatar-14.jpg"></a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-Shop\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>