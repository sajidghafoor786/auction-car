<!-- Sidebar -->
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="admin/assets.html"><i class="la la-object-ungroup"></i> <span>admin/Assets</span></a>
							</li>
							<li class="submenu">
			...
			<!-- /Sidebar --><?php /**PATH C:\xampp\htdocs\E-Shop\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>