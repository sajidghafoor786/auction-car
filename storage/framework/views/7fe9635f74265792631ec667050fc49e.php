                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        <?php if($GetEmailData['userType'] == 'Customer'): ?>
                                                                        
                                                                        Thank you! MR.
                                                                        <?php echo e($GetEmailData['order']->f_name); ?><br></h1>
                                                                        <h5> Your Order ID : <?php echo e($GetEmailData['order']->id); ?></h5>
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    #:</span></td>
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    style="font-size:14px;line-height:21px">OR#<?php echo e($GetEmailData['order']->id); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td style="padding:0;Margin:0"><span
                                                                            ...
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    <?php echo e(\Carbon\Carbon::parse($GetEmailData['order']->created_at)->format('d F, Y')); ?>
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            ...
                                                                            <td style="padding:0;Margin:0"><span
                                                                                    ...
                                                                                    <?php echo e(\Carbon\Carbon::parse($GetEmailData['order']->shipping_date)->format('d F, Y')); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <p
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <?php echo e($GetEmailData['order']->phone_no); ?></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <?php echo e($GetEmailData['order']->address); ?></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <?php echo e($GetEmailData['order']->state); ?></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <?php echo e($GetEmailData['order']->city); ?></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <?php echo e(getCountry($GetEmailData['order']->country)->name); ?>
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <?php if(!empty($GetEmailData)): ?>
                                        <?php $__currentLoopData = $GetEmailData['order']->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr style="border-collapse:collapse">
                                                <td align="left"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                ...
                                                                                Subtotal
                                                                                <?php echo e('( ' . $GetEmailData['itemCount'] . ')'); ?>

                                                                                items:</td>
                                                                            <td
                                                                                style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                                <?php echo e(number_format($GetEmailData['order']->subtotal, 2)); ?>/PKR
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                            ...
                                                                            <td
                                                                                ...
                                                                                <strong><?php echo e(number_format($GetEmailData['order']->shipping, 2)); ?>/PKR</strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                            ...
                                                                            <td
                                                                                style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px">
                                                                                <?php echo e(number_format($GetEmailData['order']->discount, 2)); ?>/PKR
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                            ...
                                                                            <td
                                                                                style="padding:0;Margin:0;text-align:right;font-size:18px;line-height:27px;color:#d48344">
                                                                                <strong><?php echo e(number_format($GetEmailData['order']->grand_total, 2)); ?>/PKR</strong>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <p
...
<?php /**PATH C:\xampp\htdocs\main\e-shop\resources\views/Email/Orderemail.blade.php ENDPATH**/ ?>