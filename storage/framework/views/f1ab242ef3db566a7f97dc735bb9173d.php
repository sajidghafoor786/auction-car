...
<?php $__env->startSection('body'); ?>
    ...
    <div class="modal fade" id="brandsEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title ms-auto" id="exampleModalLabel"> Update Brands </h5>
                    <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo e(url('brands/update')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <div class="ms-2">
                                                    <?php if(($item->image !== 'No-image.jpg')): ?>
                                                        <img src="<?php echo e(asset('upload/brands_img/' . $item->image)); ?>"
                                            ...
                                            <td class="td-actions text-right">
                                                ...
                                                <a href="<?php echo e(url('/brands/delete', $item->id)); ?> "
    ...
    <div class="modal fade" id="brandsAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title ms-auto" id="exampleModalLabel">Brands Details Here</h5>
                    <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editbtn', function() {
                ...
                $('#brandsEdit').modal('show');
                $.ajax({
                    type: "GET",
                    url: "/brands/edit/" + editId,
                    success: function(response) {
                        // console.log(response);
                        if (response.status === 200 && response.brands) {
                            $('#editId').val(editId);
                            $('#editName').val(response.brands.name);
                            $('#editSlug').val(response.brands.slug);
                            ...
                            var imageName = response.brands.image
                                .trim(); // Assuming images is a single image name
                            var imagePath = '/upload/brands_img/' + imageName;
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E-SHOP\resources\views/admin/pages/brands.blade.php ENDPATH**/ ?>