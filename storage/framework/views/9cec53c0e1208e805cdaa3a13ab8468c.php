<aside class="sidenav navbar  navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white  <?php echo e(Request::is('/') ? 'bg-gradient-primary' : ''); ?>" href="<?php echo e(url('/')); ?>">
...
</aside><?php /**PATH C:\xampp\htdocs\main\e-shop\resources\views/admin/include/sidebar.blade.php ENDPATH**/ ?>