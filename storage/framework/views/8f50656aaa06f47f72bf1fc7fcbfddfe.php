            ...
            <div class="row  py-5 mt-5">
                <div class="col-8  offset-md-2   mb-5">
                    <div CLASS=" col-md-12 text-center bg-secondary wow fadeInRight  ">
                        <h1 class="text-light">Totall_Appointment</h1>
                    </div>
                    <div class="app-card app-card shadow-sm  wow zoomIn ">
                        <div class="app-card-body p-3 ">
                            <table class="table table-striped table-hover  wow zoomIn">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $totall_appoint; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
</html><?php /**PATH C:\xampp\htdocs\laravel2\resources\views/light_admin/Dash_Data/totall_appoint.blade.php ENDPATH**/ ?>