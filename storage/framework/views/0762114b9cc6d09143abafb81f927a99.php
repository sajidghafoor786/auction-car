<div class="app-header-inner">
                        ...
                        <div class="app-utilities col-auto">
                                    ...
                                    <div class="dropdown-menu-content">
                                            ...
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image"
                                                        src="admin1/assets/images/profiles/profile-1.png" alt="">
                                                </div>
                                                <!--//col-->
                                                <div class="col">
                                                    <div class="info">
                                        ...
                                        <div class="item p-3">
                                            <div class="row gx-2 justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    <img class="profile-image"
                                                        src="admin1/assets/images/profiles/profile-2.png" alt="">
                                                </div>
                                                <!--//col-->
                                                <div class="col">
                                                    <div class="info">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    role="button" aria-expanded="false"><img src="admin1/assets/images/user.png"
                                        alt="user profile"></a>
            ...
            <!--//container-fluid-->
        </div><?php /**PATH C:\xampp\htdocs\laravel2\resources\views/light_admin/navbar.blade.php ENDPATH**/ ?>