...
<?php $__env->startSection('body'); ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title ms-auto" id="exampleModalLabel"> Update Category </h5>
                    <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo e(url('category/update')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-sm mb-0">
                            View all the Categorys.
                        </p>
                    </div>
                    <div class="table-responsive p-0">
                        <?php if($categoryOne->isNotEmpty()): ?>
                            <table class="table align-items-center mb-0 table-striped"  id="datatable-search">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $categoryOne; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            <td>
                                                <span
                                            ...
                                            <td>
                                                <div class="ms-2">
                                                    <?php if($item->image !== 'No-image.jpg'): ?>
                                                        <img src="<?php echo e(asset('upload/category_img/' . $item->image)); ?>"
                                            ...
                                            <td class="td-actions text-right">
                                                ...
                                                <a href="<?php echo e(url('/category/delete', $item->id)); ?> "
    ...
    <div class="modal fade" id="categoryAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title ms-auto" id="exampleModalLabel">Category Details Here</h5>
                    <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 200 && response.category) {
                            ...
                            // Update the status dropdown in the edit modal
                            $('#editStatus').html('<option value="1" ' + (response.category
                                    .status == 1 ? 'selected' : '') + '>Active</option>' +
                                '<option value="0" ' + (response.category.status == 0 ?
                            ...
                            var imageName = response.category.image
                                .trim(); // Assuming images is a single image name
                            var imagePath = '/upload/category_img/' + imageName;
                        ...
                        $(document).on('click', '.deleteImageBtn', function() {
                            ...
                            $.ajax({
                                type: "DELETE",
                                url: "/category/deleteimage/" + editId,
                                data: {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main\e-shop\resources\views/admin/pages/category.blade.php ENDPATH**/ ?>