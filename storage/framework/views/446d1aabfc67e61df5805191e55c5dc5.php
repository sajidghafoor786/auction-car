                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php if($myorder->isNotEmpty()): ?>
                                           ...
                                           <tr>
                                               <td>
                                                  <a href="<?php echo e(route('user.MyOrderDetails', ['id' => $item->id])); ?>">OR#<?php echo e($item->id); ?></a>
                                                 </td>
                                               <td><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('d F, Y')); ?></td>
                                               <td>
                                               ...
                                               <td><?php echo e(number_format($item->grand_total, 2)); ?></td>
                                           </tr>
...
<?php echo $__env->make('user.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main\e-shop\resources\views/user/order/myorder.blade.php ENDPATH**/ ?>