<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="admin1/assets/images/app-logo.svg"
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                <li class="nav-item">
                    ...
                    <a class="nav-link active" href="<?php echo e(url('Dashboard_Admin')); ?>">
                        <span class="nav-icon">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1"
                        ...
                        <span class="nav-icon">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-sliders"
                        ...
                        <span class="nav-link-text">MenuItem</span>
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="nav-item submenu-link">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <a class="nav-link" href="<?php echo e(url('Add_Item')); ?>">
                                    <span class="nav-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-plus-circle" width="16"
                            ...
                            <li class="nav-item submenu-link">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <a class="nav-link" href="<?php echo e(url('View_Item')); ?>">
                                    <span class="nav-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="bi-bi-eye" width="16" height="16"
                                    ...
                                    <span class="nav-link-text">View Item</span>
                                </a>
                                <!--//nav-link-->
                            </li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1"
                        ...
                        <span class="nav-icon">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-person-add"
                        ...
                        <ul class="submenu-list list-unstyled">
                            ...
                            <li class="nav-item submenu-link">
                                ...
                                <a class="nav-link" href="<?php echo e(url('showalldoctor')); ?>">
                                    ...
                                    <span class="nav-link-text">View Doctor</span>
                                </a>
                                <!--//nav-link-->
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="<?php echo e(url('myappointment')); ?>">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-journal-text" width="16" height="16"
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link" href="<?php echo e(url('admin_setting')); ?>">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-gear-fill" width="16" height="16"
                        ...
                        <span class="nav-link-text">Admin Setting</span>
                    </a>
                    <!--//nav-link-->
                </li>
    ...
    <!--//sidepanel-inner-->
</div><?php /**PATH C:\xampp\htdocs\laravel2\resources\views/light_admin/sidebar.blade.php ENDPATH**/ ?>