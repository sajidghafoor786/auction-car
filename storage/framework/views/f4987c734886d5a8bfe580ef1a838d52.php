...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="<?php echo e(asset('admin-2/assets/css/material-dashboard.css?v=3.1.0')); ?>" rel="stylesheet" />
    <!-- Include Toastr CSS -->
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            <div class="content">
                <main class="main-content  mt-0">
                    <div class="page-header align-items-start min-vh-100" style="background-image: url('<?php echo e(asset('logo/auth/images.jp')); ?>');">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group small text-end">
                                                ...
                                                <p class="mt-4 text-sm text-center">
                                                    ...
                                                    <a href="<?php echo e(route('admin.register')); ?>" class="text-primary text-gradient font-weight-bold">Sign
                                                        up</a>
                                                </p>
                                            </form>
                                        </div>
    ...
    <script src="<?php echo e(asset('admin-2/assets/js/core/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin-2/assets/js/core/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin-2/assets/js/plugins/perfect-scrollbar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin-2/assets/js/plugins/smooth-scrollbar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admin-2/assets/js/plugins/chartjs.min.js')); ?>"></script>
    <script>
...
</html><?php /**PATH C:\xampp\htdocs\E-SHOP\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>