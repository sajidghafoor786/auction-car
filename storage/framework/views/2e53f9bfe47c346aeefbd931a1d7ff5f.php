...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="status" class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>">
                                ...
                                <option value="active" <?php echo e(old('status') == "active" ? 'selected' : ''); ?> <?php echo e($auction->status == "active" ? 'selected' : ''); ?>> Active</option>
                                <option value="closed" <?php echo e(old('status') == "closed" ? 'selected' : ''); ?> <?php echo e($auction->status == "closed" ? 'selected' : ''); ?>> Closed</option>
                            </select>
