...
<head>
    ...
    <link href="{{ asset('admin-2/assets-2/css/nucleo-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin-2/assets-2/css/nucleo-svg.css') }}" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css"
        integrity="sha512-q3eWabyZPc1XTCmF+8/LuE1ozpg5xxn7iO89yfSOd5/oKvyqLngoNGsx8jq92Y8eXJ/IRxQbEC+FGSYxtk2oiw=="
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
    <link id="pagestyle" href="{{ asset('admin-2/assets-2/css/material-dashboard.minaf3e.css?v=3.0.6') }}"
        rel="stylesheet" />
    <link id="pagestyle" href="{{ asset('admin-2/assets-2/css/datetimepicker.css') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <script src="{{ asset('admin-2/assets-2/js/core/popper.min.js') }}"></script>
    <script src="{{ asset('admin-2/assets-2/js/core/bootstrap.min.js') }}"></script>
    <script src="{{ asset('admin-2/assets-2/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('admin-2/assets-2/js/plugins/smooth-scrollbar.min.js') }}"></script>

    <script src="{{ asset('admin-2/assets-2/js/plugins/dragula/dragula.min.js') }}"></script>
    <script src="{{ asset('admin-2/assets-2/js/plugins/jkanban/jkanban.js') }}"></script>
    <script src="{{ asset('admin-2/assets-2/js/plugins/datatables.js') }}"></script>
    <script src="{{ asset('admin-2/assets-2/js/plugins/datetimepicker.js') }}"></script>
    ...
    <script src="{{ asset('admin-2/assets-2/js/material-dashboard.minaf3e.js?v=3.0.6') }}"></script>
