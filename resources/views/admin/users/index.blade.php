...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-2">
            <div class="col-lg-12">
                <a href="{{ route('createUser') }}" class="btn btn-primary float-end">Add User</a>
            </div>
        </div>
        <div class="card p-3">
                    ...
                    @foreach($users as $user)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                @if($user->permissions && $user->permissions->count())
                                    @foreach($user->permissions as $perm)
                                        <span class="badge bg-primary mb-1">{{ $perm->title }}</span>
                                    @endforeach
                                @else
                            ...
                            <td>
                                ...
                                <a class="dropdown-item" href="{{ route('viewUser', $user->id) }}">
